...
export default function AuthProvider({ children }) {
  ...
  const needsSession = pathname === "/login" || pathname.startsWith("/admin") || pathname.startsWith("/consulta") || pathname.startsWith("/presencas") || pathname.startsWith("/presenca") || pathname.startsWith("/voluntario");
