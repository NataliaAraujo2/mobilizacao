...
import { getPublicReport, getPublicReportUrl, MAX_REPORT_SIZE, publishReport2025 } from "../services/reportsService";
...
export default function ReportsAdminPage() {
  ...
  async function handleSubmit(event) {
    ...
    setMessage("");
    try {
      await publishReport2025(file, user.uid, (sent, total) => setProgress(total ? Math.round((sent / total) * 100) : 0));
