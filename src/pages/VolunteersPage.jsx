    ...
    <main className={styles.page}>
      ...
      {showForm && <section className={styles.card} aria-labelledby="volunteer-form-title">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label>E-mail<ContactInput required type="email" maxLength="160" autoComplete="email" value={form.email} onChange={(event) => setForm({ ...form, email: event.target.value })} /></label>
          <label>Telefone<ContactInput required type="tel" inputMode="tel" autoComplete="tel" value={form.phone} onChange={(event) => setForm({ ...form, phone: formatPhone(event.target.value) })} /></label>
